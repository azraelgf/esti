...
export function menuInit() {
	if (document.querySelector(".icon-menu")) {
		document.addEventListener("click", function (e) {
			const activeMenu = document.querySelector('._submenu-active'),
				activeMenuSub = document.querySelector('._submenu-open'),
				activeMenuInSub = document.querySelector('._insubmenu-open');
